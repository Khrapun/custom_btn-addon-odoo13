...
class Student(models.Model):
    ...
    def return_fields(self):
        dropdown_field = self.env.context.get('create_button_dropdown_field', False)
        if hasattr(self._fields[dropdown_field], 'selection'):
            return json.dumps(self._fields[dropdown_field].selection)
        return []
